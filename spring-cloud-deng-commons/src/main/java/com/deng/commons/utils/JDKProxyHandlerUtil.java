 ...
 * @Date 2021/8/2
 */
public class JDKProxyHandlerUtil implements InvocationHandler {

    private Object target;

    public JDKProxyHandlerUtil(Object target) {
        this.target = target;
    }
    ...
    public static <T> T createProxy(Object target, Class<T> targetInterface) {
        ...
        return (T) Proxy.newProxyInstance(target.getClass().getClassLoader(), target.getClass().getInterfaces(), new JDKProxyHandlerUtil(target));
    }

    /*public static void main(String[] args) {
        IService serviceA = JDKProxyHandler.createProxy(new ServiceA(), IService.class);
        serviceA.m1();
    }*/
}
